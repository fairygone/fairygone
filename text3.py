...
class HlmNameCount():
    ...
    def getNameTimesSort(self, name_path, txt_path):
        # 将所有人名临时添加到jieba所用字典，以使jieba能识别所有人名
        # 打开name文件,获取人物表
        file_name=open(r"txt/name_table.txt","r",encoding="UTF-8").read()
...
if __name__ == '__main__':
    ...
    txt_path = 'txt/hlm_ANSI.txt'
    hnc = HlmNameCount()
    hnc.getNameTimesSort(name_path, txt_path)
